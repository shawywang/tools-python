...
wangzefu: List[List[str]] = [
    ...
    ["玄孙王", "泽福/泽录/淼", "玄孙", "媳/", "廖俊", "来孙", "男/女", "王", "骁/云慧"], ["故高祖", "父/母", "王公", "讳/宅", "支和/伯君", "老", "大/孺", "人二位收用"],
    ...
    ["孙", "婿/女", "王泽福/廖俊", "外曾孙", "男/女", "王骁/王云慧"], ["故太岳", "父/母", "廖公", "讳/", "明富老大人一位收用"],
...
def main():
    ...
    for i, l in enumerate(newList):
        ...
        # 中元堂前化帛、保佑清太吉祥如意
        h.make_data(thing="端午化钱", num="十", add=["  ", "保佑清太/吉祥如意", "路边化钱"], ti="丙午二〇二六年五月初五日")
        h.horizontal_count()
        h.vertical_count()
        h.gen_font_size()
        h.gen_index()
