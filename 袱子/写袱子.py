...
wangzefu: List[List[str]] = [
    ...
    ["孙男王", "泽福/泽录/淼", "孙", "媳/", "廖俊", "曾孙", "男/女", "王", "骁/云慧"], ["故祖", "父/母", "王", "公/", "讳/宅", "守玺/庞怀美", "老", "大/孺", "人二位收用"],
    ["曾孙王", "泽福/泽录/淼", "曾孙", "媳/", "廖俊", "玄孙", "男/女", "王", "骁/云慧"], ["故曾祖", "父/母", "王", "公/", "讳/宅", "尚安/陈君", "老", "大/孺", "人二位收用"],
    ["曾孙王", "泽福/泽录/淼", "曾孙", "媳/", "廖俊", "玄孙", "男/女", "王", "骁/云慧"], ["故曾祖", "父/母", "王", "公/", "讳/宅", "尚璋/刘君", "老", "大/孺", "人二位收用"],
    ["玄孙王", "泽福/泽录/淼", "玄孙", "媳/", "廖俊", "来孙", "男/女", "王", "骁/云慧"], ["故高祖", "父/母", "王", "公/", "讳/宅", "支和/伯君", "老", "大/孺", "人二位收用"],
    ["玄孙王", "泽福/泽录/淼", "玄孙", "媳/", "廖俊", "来孙", "男/女", "王", "骁/云慧"], ["故高祖", "父/母", "王", "公/", "讳/宅", "支江/刘君", "老", "大/孺", "人二位收用"],
    ["来孙王", "泽福/泽录/淼", "来孙", "媳/", "廖俊", "晜孙", "男/女", "王", "骁/云慧"], ["故天祖", "父/母", "王", "公/", "讳/宅", "万荣/李君", "老", "大/孺", "人二位收用"],
    ["晜孙王", "泽福/泽录/淼", "晜孙", "媳/", "廖俊", "仍孙", "男/女", "王", "骁/云慧"], ["故烈祖", "父/母", "王", "公/", "讳/宅", "自元/赵君", "老", "大/孺", "人二位收用"],
    ["仍孙王", "泽福/泽录/淼", "仍孙", "媳/", "廖俊", "云孙", "男/女", "王", "骁/云慧"], ["故太祖", "父/母", "王", "公/", "讳/宅", "敏/闫君", "老", "大/孺", "人二位收用"],
    ["云孙王", "泽福/泽录/淼", "云孙", "媳/", "廖俊", "耳孙", "男/女", "王", "骁/云慧"], ["故远祖", "父/母", "王", "公/", "讳/宅", "耀德/罗君", "老", "大/孺", "人二位收用"],
    ["耳孙王", "泽福/泽录/淼", "耳孙", "媳/", "廖俊", "十世孙", "男/女", "王", "骁/云慧"], ["故鼻祖", "父/母", "王", "公/", "讳/宅", "映爵/罗君", "老", "大/孺", "人二位收用"],
    ["十世孙王", "泽福/泽录/淼", "十世孙", "媳/", "廖俊", "十一世孙", "男/女", "王", "骁/云慧"], ["故十世祖", "父/母", "王", "公/", "讳/宅", "述先/汪君", "老", "大/孺", "人二位收用"],
    ["十一世孙王", "泽福/泽录/淼", "十一世孙", "媳/", "廖俊", "十二世孙", "男/女", "王", "骁/云慧"], ["故十一世祖", "父/母", "王", "公/", "讳/宅", "西成/谢君/汪君", "老", "大/孺", "人二位收用"],
    ["十二世孙王", "泽福/泽录/淼", "十二世孙", "媳/", "廖俊", "十三世孙", "男/女", "王", "骁/云慧"], ["故十二世祖", "父/母", "王", "公/", "讳/宅", "心田/刘君/谢君", "老", "大/孺", "人二位收用"],

    ["孝", "婿/女", "王泽福/廖俊", "外孙", "男/女", "王骁/王云慧"], ["故岳", "父/母", "廖", "公/", "讳/宅", "清贤/曹庭秀", "老", "大/孺", "人二位收用"],
    ["孙", "婿/女", "王泽福/廖俊", "外曾孙", "男/女", "王骁/王云慧"], ["故太岳", "父/母", "廖", "公讳/", "明富老大人一位收用"],
    ["外曾孙男王", "泽福/泽录/淼", "外曾孙", "媳/", "廖俊", "外玄孙", "男/女", "王骁/王云慧"], ["故外曾祖", "父/母", "庞", "公/", "讳/宅", "义容/李君", "老", "大/孺", "人二位收用"],
    ["外孙男王", "泽福/泽录/淼", "外孙", "媳/", "廖俊", "外曾孙", "男/女", "王骁/王云慧"], ["故外祖", "父/母", "张", "公/", "讳/宅", "家运/朱友芬", "老", "大/孺", "人二位收用"],
    ["外曾孙男王", "泽福/泽录/淼", "外曾孙", "媳/", "廖俊", "外玄孙", "男/女", "王骁/王云慧"], ["故外曾祖", "父/母", "张", "公/", "讳/宅", "邦恩/秦君", "老", "大/孺", "人二位收用"],

    [" 下民", "王泽福/廖俊/王泽录/王淼", " 王", "骁/云慧"], ["本境土地福德正神祠前收用"],
    [" 下民", "王泽福/廖俊/王泽录/王淼", " 王", "骁/云慧"], ["地盘业主孤魂野鬼魂下收用"],

    ["孙", "男/女", "王", "建亮/建霞", "孙", "媳/", "胡彩娥", "曾孙王", "晶晶/炜承/彦涵"], ["故祖", "父/母", "王", "公/", "讳/宅", "文鸿/卫兰英", "老", "大/孺", "人二位收用"],
]
...
class Handle:
    ...
    def make_data(self, thing: str, num: str, add: List[str], ti: str):
        ...
        self.content.insert(1, [f"  谨具冥财 {num}封奉/上"])  # 虔具信伏
...
def main():
    ...
    for i, l in enumerate(newList):
        ...
        # 中元堂前化帛、保佑清太吉祥如意
        h.make_data(thing="今逢端午", num="十", add=["  路边化钱"], ti="丙午二〇二六年五月初五日")
        h.horizontal_count()
        h.vertical_count()
        h.gen_font_size()
        h.gen_index()
