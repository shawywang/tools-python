...
wang_ze_fu: List[List[str]] = [
    # ============曹家1=============
    ["孝", "外甥孫", "婿/女", "王澤福/廖俊", "玄孫", "王驍/王雲慧"], ["故內外祖顯", "考/妣", "曹", "公諱仕營/宅胡君應軒/繼男袁昌敬", "老", "大/孺", "人收用"],
    # ============廖家4=============
    ["孝", "婿/女", "王澤福/廖俊", "外孫", "王驍/王雲慧"], ["故嶽顯", "考/妣", "廖", "公諱清賢/宅曹君庭秀", "老", "大/孺", "人二位收用"],
    ["孫", "婿/女", "王澤福/廖俊", "外曾孫", "王驍/王雲慧"], ["故太嶽顯", "考/妣", "廖", "公諱明富/宅楊君", "老", "大/孺", "人二位收用"],
    ["妹", "夫/", "王澤福/廖俊", "外甥", "王驍/王雲慧"], ["故內兄廖公", "諱/", "仕永", "老大人一位收用"],
    ["妹", "夫/", "王澤福/廖俊", "姨甥", "王驍/王雲慧"], ["故內", "兄/姐", "曹", "公諱汝成/宅廖君仕珍", "老", "大/孺", "人二位收用"],
    # ============庞家1=============
    ["外曾孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外玄孫", "王驍/王雲慧"], ["故外曾祖顯", "考/妣", "龐", "公諱義容/宅李君", "老", "大/孺", "人二位收用"],
    # ============张家2=============
    ["外孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外曾孫", "王驍/王雲慧"], ["故外祖顯", "考/妣", "張", "公諱家運/宅朱君友芬", "老", "大/孺", "人二位收用"],
    ["外曾孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外玄孫", "王驍/王雲慧"], ["故外曾祖顯", "考/妣", "張", "公諱邦恩/宅秦君", "老", "大/孺", "人二位收用"],
    # ============王家15=============
    ["孝男王", "澤福/澤錄/淼", "孝", "媳/", "廖俊//", "孝孫", "王", "驍/雲慧"], ["故顯考王公", "諱/", "汝上老大人一位收用"],
    ["侄男王", "澤福/澤錄/淼", "侄媳/", "廖俊//", "侄孫", "王", "驍/雲慧"], ["故伯考王公", "諱/", "汝忠老大人一位收用"],
    ["孫男王", "澤福/澤錄/淼", "孫", "媳/", "廖俊//", "曾孫", "王", "驍/雲慧"], ["故祖顯", "考/妣", "王", "公諱守璽/宅龐君懷美", "老", "大/孺", "人二位收用"],
    ["曾孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "玄孫", "王", "驍/雲慧"], ["故曾祖顯", "考/妣", "王", "公諱尚安/宅陳君", "老", "大/孺", "人二位收用"],
    ["曾孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "玄孫", "王", "驍/雲慧"], ["故曾祖顯", "考/妣", "王", "公諱尚璋/宅劉君", "老", "大/孺", "人二位收用"],
    ["玄孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "來孫", "王", "驍/雲慧"], ["故高祖顯", "考/妣", "王", "公諱支和/宅伯君", "老", "大/孺", "人二位收用"],
    ["玄孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "來孫", "王", "驍/雲慧"], ["故高祖顯", "考/妣", "王", "公諱支江/宅劉君", "老", "大/孺", "人二位收用"],
    ["來孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "晜孫", "王", "驍/雲慧"], ["故天祖顯", "考/妣", "王", "公諱萬榮/宅李君", "老", "大/孺", "人二位收用"],
    ["晜孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "仍孫", "王", "驍/雲慧"], ["故烈祖顯", "考/妣", "王", "公諱自元/宅趙君", "老", "大/孺", "人二位收用"],
    ["仍孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "雲孫", "王", "驍/雲慧"], ["故太祖顯", "考/妣", "王", "公諱敏/宅閻君", "老", "大/孺", "人二位收用"],
    ["雲孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "耳孫", "王", "驍/雲慧"], ["故遠祖顯", "考/妣", "王", "公諱耀德/宅羅君", "老", "大/孺", "人二位收用"],
    ["耳孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十世孫", "王", "驍/雲慧"], ["故鼻祖顯", "考/妣", "王", "公諱映爵/宅羅君", "老", "大/孺", "人二位收用"],
    ["十世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十一世孫", "王", "驍/雲慧"], ["故十世祖顯", "考/妣", "王", "公諱述先/宅汪君", "老", "大/孺", "人二位收用"],
    ["十一世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十二世孫", "王", "驍/雲慧"], ["故十一世祖顯", "考/妣", "王", "公//宅", "諱西成/謝君/汪君", "老", "大/孺", "人三位收用"],
    ["十二世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十三世孫", "王", "驍/雲慧"], ["故十二世祖顯", "考/妣", "王", "公//宅", "諱心田/劉君/謝君", "老", "大/孺", "人三位收用"],
    # ============土地、孤魂野鬼2=============
    ["下民", "王澤福/王澤錄/王淼", "廖俊/", "王驍/王雲慧"], ["本境土地福德正神祠前收用"],
    ["下民", "王澤福/王澤錄/王淼", "廖俊/", "王驍/王雲慧"], ["地盤業主孤魂野鬼魂下收用"],
    # ============晶晶王家2=============
    ["孫", "男/女", "王", "建亮/建霞", "孫", "媳/", "胡彩娥/", "曾孫王", "晶晶/煒承/彥涵"], ["故祖顯", "考/妣", "王", "公諱文鴻/宅衛君蘭英", "老", "大/孺", "人二位收用"],
    ["侄", "男/女", "王", "建亮/建霞", "侄", "媳/", "胡彩娥/", "侄孫王", "晶晶/煒承/彥涵"], ["故叔顯考王公", "諱/", "米留", "老大人一位收用"],
    # ============样例王永雄=============

    ["孝男王永", "雄/開/躍", "媳/", "張秀華/劉方勝/劉翠英", "孫", "男/女", "王定海/毛勇/劉位/王雪蓮/王雪萍", "孫", "媳/婿", "陳曉麗/侯富馨"], ["故顯", "考/妣", "王", "公諱澤周/宅朱君寄春", "老", "大/孺", "人二位收用"],
]

zhushiquan: List[List[str]] = [
    # ============朱家（朱仕全）=============
    ["孝孫", "男朱仕全/媳張为菊", "重孫朱", "建華/麗娟/家甫", "婿/媳", "黃維剛/楊海紅/向玉萍", "玄孫", "朱儁林/黃婉茹/楊明鎮/朱崇爾/朱浩瑞"], ["故祖顯", "考/妣", "朱", "公諱如杷/宅義君", "老", "大/孺", "人二位收用"],
    ["孝", "男朱仕全/媳張为菊", "孫朱", "建華/麗娟/家甫", "婿/媳", "黃維剛/楊海紅/向玉萍", "重孫", "朱儁林/黃婉茹/楊明鎮/朱崇爾/朱浩瑞"], ["故顯", "考/妣", "朱", "公諱有飛/宅劉君", "老", "大/孺", "人二位收用"],
    # ============张家（朱仕全）=============
    ["孝", "女張为菊/婿朱仕全", "外孫朱", "建華/麗娟/家甫", "婿/媳", "黃維剛/楊海紅/向玉萍", "外玄孫", "朱儁林/黃婉茹/楊明鎮/朱崇爾/朱浩瑞"], ["故嶽顯", "考/妣", "張", "公諱家運/宅朱君友芬", "老", "大/孺", "人二位收用"],

    # ============何家（朱家甫）=============
    ["外孫", "女向玉萍/婿朱家甫", "外重孫", "朱浩瑞/朱崇爾"], ["故外祖顯考", "何公", "諱/", "鍾生老大人一位收用"],
    ["外孫", "女向玉萍/婿朱家甫", "外重孫", "朱浩瑞/朱崇爾"], ["故外祖顯", "考/妣", "何", "公諱顯成/宅王孝品", "老", "大/孺", "人二位收用"],
    # ============向家（朱家甫）=============
    ["孝孫", "女向玉萍/婿朱家甫", "重孫", "朱浩瑞/朱崇爾"], ["故祖顯", "考/妣", "向", "公諱思銀/宅王君", "老", "大/孺", "人二位收用"],
    ["孝", "女向玉萍/婿朱家甫", "外孫", "朱浩瑞/朱崇爾"], ["故嶽顯", "考/妣", "向", "公諱安雲/宅何君光蘭", "老", "大/孺", "人二位收用"],
    
    # ============张家（朱建华）=============
    ["外孫朱", "建華/麗娟/家甫", "婿/媳", "黃維剛/楊海紅/向玉萍", "外曾孫", "朱儁林/黃婉茹/楊明鎮/朱崇爾/朱浩瑞"], ["故外祖顯", "考/妣", "張", "公諱家運/宅朱君友芬", "老", "大/孺", "人二位收用"],
    ["外曾孫朱", "建華/麗娟/家甫", "孫", "婿/媳", "黃維剛/楊海紅/向玉萍", "外玄孫", "朱儁林/黃婉茹/楊明鎮/朱崇爾/朱浩瑞"], ["故外曾祖顯", "考/妣", "張", "公諱邦恩/宅秦君", "老", "大/孺", "人二位收用"],
]
...
def main():
    ...
    whogive = wang_ze_fu
    n = 2  # 每组2个元素
    newList = [whogive[i:i + n] for i in range(0, len(whogive), n)]
    for i, l in enumerate(newList):
        ...
        # 中元堂前化帛、保佑清太吉祥如意
        h.make_data(thing="中元化錢", add=["    路邊化錢"], ti="丙午二〇二六年七月十四日")  # 路邊化錢
        h.horizontal_count()
        h.vertical_count()
        h.gen_font_size()
        h.gen_index()
