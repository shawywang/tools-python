...
wangzefu: List[List[str]] = [
    ...
    ["云孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "耳孫", "男/女", "王", "驍/云慧"], ["故远祖", "考/妣", "王", "公諱耀德/宅羅君", "老", "大/孺", "人二位收用"],
...
wangxiong: List[List[str]] = [["孝男王永", "雄/开/跃", "孝媳", "張秀华/劉方胜/劉翠英", "孝孫", "男/女", "王定海/毛勇/劉位/王雪莲/王雪萍", "孝孫", "媳/婿", "陳晓丽/侯富馨"], ["故慈母王", "宅/", "朱君寄春老孺人一位收用"]]
