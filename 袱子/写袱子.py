...
wangzefu: List[List[str]] = [
    ["孝", "婿/女", "王澤福/廖俊", "外孫", "王驍/王雲慧"], ["故嶽", "考/妣", "廖", "公諱清賢/宅曹君庭秀", "老", "大/孺", "人二位收用"],
    ["孫", "婿/女", "王澤福/廖俊", "外曾孫", "王驍/王雲慧"], ["故太嶽", "考/妣", "廖", "公諱明富/宅楊君", "老", "大/孺", "人二位收用"],
    ["妹", "夫/", "王澤福/廖俊", "外甥", "王驍/王雲慧"], ["故內兄廖公", "諱/", "仕永", "老大人一位收用"],
    ["妹", "夫/", "王澤福/廖俊", "姨甥", "王驍/王雲慧"], ["故內姐廖公", "諱/", "仕珍", "老孺人一位收用"],

    ["外曾孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外玄孫", "王驍/王雲慧"], ["故外曾祖", "考/妣", "龐", "公諱義容/宅李君", "老", "大/孺", "人二位收用"],

    ["外孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外曾孫", "王驍/王雲慧"], ["故外祖", "考/妣", "張", "公諱家運/宅朱君友芬", "老", "大/孺", "人二位收用"],
    ["外曾孫男王", "澤福/澤錄/淼", "媳/", "廖俊//", "外玄孫", "王驍/王雲慧"], ["故外曾祖", "考/妣", "張", "公諱邦恩/宅秦君", "老", "大/孺", "人二位收用"],

    ["孝男王", "澤福/澤錄/淼", "孝", "媳/", "廖俊//", "孝孫", "王", "驍/雲慧"], ["故顯考王公", "諱/", "汝上老大人一位收用"],
    ["孫男王", "澤福/澤錄/淼", "孫", "媳/", "廖俊//", "曾孫", "王", "驍/雲慧"], ["故祖", "考/妣", "王", "公諱守璽/宅龐君懷美", "老", "大/孺", "人二位收用"],
    ["曾孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "玄孫", "王", "驍/雲慧"], ["故曾祖", "考/妣", "王", "公諱尚安/宅陳君", "老", "大/孺", "人二位收用"],
    ["曾孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "玄孫", "王", "驍/雲慧"], ["故曾祖", "考/妣", "王", "公諱尚璋/宅劉君", "老", "大/孺", "人二位收用"],
    ["玄孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "來孫", "王", "驍/雲慧"], ["故高祖", "考/妣", "王", "公諱支和/宅伯君", "老", "大/孺", "人二位收用"],
    ["玄孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "來孫", "王", "驍/雲慧"], ["故高祖", "考/妣", "王", "公諱支江/宅劉君", "老", "大/孺", "人二位收用"],
    ["來孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "晜孫", "王", "驍/雲慧"], ["故天祖", "考/妣", "王", "公諱萬榮/宅李君", "老", "大/孺", "人二位收用"],
    ["晜孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "仍孫", "王", "驍/雲慧"], ["故烈祖", "考/妣", "王", "公諱自元/宅趙君", "老", "大/孺", "人二位收用"],
    ["仍孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "雲孫", "王", "驍/雲慧"], ["故太祖", "考/妣", "王", "公諱敏/宅閻君", "老", "大/孺", "人二位收用"],
    ["雲孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "耳孫", "王", "驍/雲慧"], ["故遠祖", "考/妣", "王", "公諱耀德/宅羅君", "老", "大/孺", "人二位收用"],
    ["耳孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十世孫", "王", "驍/雲慧"], ["故鼻祖", "考/妣", "王", "公諱映爵/宅羅君", "老", "大/孺", "人二位收用"],
    ["十世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十一世孫", "王", "驍/雲慧"], ["故十世祖", "考/妣", "王", "公諱述先/宅汪君", "老", "大/孺", "人二位收用"],
    ["十一世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十二世孫", "王", "驍/雲慧"], ["故十一世祖", "考/妣", "王", "公//宅", "諱西成/謝君/汪君", "老", "大/孺", "人三位收用"],
    ["十二世孫王", "澤福/澤錄/淼", "媳/", "廖俊//", "十三世孫", "王", "驍/雲慧"], ["故十二世祖", "考/妣", "王", "公//宅", "諱心田/劉君/謝君", "老", "大/孺", "人三位收用"],

    [" 下民", "王澤福/廖俊/王澤錄/王淼", " ", "王驍/王雲慧"], ["本境土地福德正神祠前收用"],
    [" 下民", "王澤福/廖俊/王澤錄/王淼", " ", "王驍/王雲慧"], ["地盤業主孤魂野鬼魂下收用"],

    ["孫", "男/女", "王", "建亮/建霞", "孫", "媳/", "胡彩娥/", "曾孫王", "晶晶/煒承/彥涵"], ["故祖", "考/妣", "王", "公諱文鴻/宅衛君蘭英", "老", "大/孺", "人二位收用"],
    ["侄", "男/女", "王", "建亮/建霞", "侄", "媳/", "胡彩娥/", "侄孫王", "晶晶/煒承/彥涵"], ["故叔考王公", "諱/", "米留", "老大人一位收用"],
]
# wangzefu: List[List[str]] = [
#     ["孝男王", "澤福/澤錄/淼", "孝", "媳/", "廖俊//", "孝孫", "男/女", "王", "驍/雲慧"], ["故顯考王公", "諱/", "汝上老大人一位收用"],
#     [" 下民", "王澤福/廖俊/王澤錄/王淼", " ", "王驍/王雲慧"], ["本境土地福德正神祠前收用"],
#     [" 下民", "王澤福/廖俊/王澤錄/王淼", " ", "王驍/王雲慧"], ["地盤業主孤魂野鬼魂下收用"],
# ]
...
def main():
    ...
    for i, l in enumerate(newList):
        ...
        # 中元堂前化帛、保佑清太吉祥如意
        h.make_data(thing="端午之期", num="七", add=["    路邊化錢"], ti="丙午二〇二六年五月初六日")
        h.horizontal_count()
        h.vertical_count()
        h.gen_font_size()
        h.gen_index()
